...
## Надані матеріали охоплюють шрокий спектр концепцій, методів та алгоритмів ML, DL, NN, що дозволяє оволодіти знаннями відповідного профілю на різних рівнях.

## Орієнтовано на спеціальності першого (бакалаврського) рівня
...
### Лекція 1.1. Введення в штучний інтелект (AI). Історичний огляд, персоналії. Огляд завдань царині штучного інтелекту.

### Лекція 1.2. Машинне навчання (DL): модель, навчання, інференс. Види машинного навчання.  

### Лекція 1.3. Датасет. Поняття датасету. Організація дадасету для машинного навчання. Приклади (Scikit-Learn).
